...
import com.example.appmarte.Local.MarsDao
...
//    fun getTaskById(localid:Int):LiveData<MarsRealState>{
//        return marsDao.getTaskByType(localid)
//    }
